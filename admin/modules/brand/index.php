...
<body>
    <?php
        ...
        if(isset($_GET['idbrand'])) {
            $idDelte = $_GET['idbrand'];

            echo '<script type="text/javascript">
                if (confirm("Do you want to delete this order??")) {
                    window.location.href = "delete.php?idbrand='.$idDelte.'";
                } else {
            ...
            <div class="container">
                <div class="row">
                    ...
                    <form method="post" id="f_search">
                        <input id="txtSearch" type="search" name="search" placeholder="Enter brand name...">
                        ...
                        <div class="widget widget-table action-table">
                            ...
                            <div class="widget-content">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $pages = mysqli_query($conn, "SELECT * FROM brands WHERE active != 2");
                                        ...
                                        if (isset($_POST['submit'])) {
                                            $result = $_POST['search'];
                                            if (empty($result)) {
                                                $sql = "SELECT * FROM brands WHERE active != 2 ORDER BY sort_order ASC ";
                                            } else {
                                                $sql = "SELECT * FROM brands b WHERE b.bname LIKE '%" . $result . "%'";
                                            }
                                        } else {
                                            $sql = "SELECT * FROM brands WHERE active != 2 ORDER BY sort_order ASC LIMIT $begin, $item";
                                        }
                                        ...
                                        while ($row = mysqli_fetch_array($query)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="../../uploads/<?php echo $row['image_url']; ?>" width="50%"></td>
                                                ...
                                                <td></td>
                                                <td class="td-actions">
                                                    <a href="edit.php?idbrand=<?php echo $row['id']; ?>" class="btn btn-small btn-success">
                                                        <i class="icon-large icon-pencil"> </i>
                                                    </a>
                                                    <a href="index.php?idbrand=<?php echo $row['id']; ?>" class="btn btn-danger btn-small">
